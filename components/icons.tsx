...
export const InstagramIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path d="M12 12a4 4 0 100-8 4 4 0 000 8zm0-6a2 2 0 110 4 2 2 0 010-4z" />
        <rect width="2" height="2" x="16" y="6" rx="1" />
    </svg>
);
...
export const LinkedInIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M6.5 21.5h-5v-13h5v13zM4 6.5C2.5 6.5 1.5 5.5 1.5 4S2.5 1.5 4 1.5 6.5 2.5 6.5 4 5.5 6.5 4 6.5zm11.5 6c-2.219 0-3.5 1.156-3.5 1.156V13h-5v13h5v-6.25c0-1.656.313-3.25 2.375-3.25 1.875 0 2.125 1.5 2.125 3.375V26h5v-7.313c0-4.25-2.25-6.187-5-6.187z" />
    </svg>
);
